  ...
  return (
    <main>
      ...
      <section className="about" id="about">
        <h2>
          Hi, I am <h2 className="name">Victor Obumere</h2>
        </h2>
        <h2>A Full Stack Developer</h2>
        <p>
          I am responsible for the design and construction of websites and
          mobile application to meet user expectations{" "}
        </p>
